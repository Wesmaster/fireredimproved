...
u16 sForestSpecies[] = { SPECIES_CATERPIE, SPECIES_WEEDLE, SPECIES_PIDGEY, SPECIES_RATTATA, SPECIES_SPEAROW, SPECIES_PIKACHU, SPECIES_VULPIX, SPECIES_FARFETCHD, SPECIES_EEVEE, SPECIES_SENTRET, SPECIES_HOOTHOOT, SPECIES_LEDYBA };
