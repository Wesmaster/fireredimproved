...
const struct MapConfiguration sConfiguration[] = 
{
    ...
    { BUILDING, { SPECIES_RATTATA, SPECIES_EKANS, SPECIES_PICHU, SPECIES_ZUBAT, SPECIES_PARAS, SPECIES_ABRA, SPECIES_MAGNEMITE, SPECIES_GRIMER, SPECIES_GASTLY, SPECIES_VOLTORB, SPECIES_KOFFING, SPECIES_DITTO, SPECIES_MISDREAVUS, SPECIES_UNOWN, SPECIES_ELEKID, SPECIES_BALTOY, SPECIES_PLUSLE, SPECIES_MINUN, } },
    ...
    { GHOST, { SPECIES_GASTLY, SPECIES_MISDREAVUS, SPECIES_DUSKULL, SPECIES_SHUPPET, SPECIES_DUSKULL, SPECIES_SHUPPET, } },
