...
const struct MapConfiguration sConfiguration[] = 
{
    ...
    { FIELDS, { SPECIES_BUTTERFREE, SPECIES_BEEDRILL, SPECIES_PIDGEY, SPECIES_RATTATA, SPECIES_SPEAROW, SPECIES_EKANS, SPECIES_PICHU, SPECIES_SANDSHREW, SPECIES_VULPIX, SPECIES_ODDISH, SPECIES_ABRA, SPECIES_PONYTA, SPECIES_EXEGGCUTE, SPECIES_TANGELA, SPECIES_TAUROS, SPECIES_DITTO, SPECIES_EEVEE, SPECIES_SENTRET, SPECIES_HOOTHOOT, SPECIES_LEDYBA, SPECIES_SPINARAK, SPECIES_TOGEPI, SPECIES_NATU, SPECIES_MAREEP, SPECIES_HOPPIP, SPECIES_SUNKERN, SPECIES_YANMA, SPECIES_MURKROW, SPECIES_WYNAUT, SPECIES_SNEASEL, SPECIES_SWINUB, SPECIES_SKARMORY, SPECIES_STANTLER, SPECIES_MILTANK, SPECIES_ZIGZAGOON, SPECIES_WURMPLE, SPECIES_TAILLOW, SPECIES_SPOINK, SPECIES_PLUSLE, SPECIES_MINUN, } },
    { GARDEN, { SPECIES_BUTTERFREE, SPECIES_BEEDRILL, SPECIES_MEOWTH, SPECIES_GROWLITHE, SPECIES_ABRA, SPECIES_DITTO, SPECIES_LEDYBA, SPECIES_SPINARAK, SPECIES_HOPPIP, SPECIES_SUNKERN, SPECIES_SNUBBULL, SPECIES_HOUNDOUR, SPECIES_POOCHYENA, SPECIES_ZIGZAGOON, SPECIES_SKITTY, SPECIES_ELECTRIKE, } },
    { TUNNEL, { SPECIES_MACHOP, SPECIES_GEODUDE, SPECIES_ONIX, SPECIES_RHYHORN, SPECIES_DITTO, SPECIES_SPINARAK, } },
    { CAVE, { SPECIES_RATTATA, SPECIES_ZUBAT, SPECIES_PARAS, SPECIES_VENOMOTH, SPECIES_DIGLETT, SPECIES_ABRA, SPECIES_DITTO, SPECIES_SPINARAK, SPECIES_DUNSPARCE, SPECIES_DELIBIRD, SPECIES_SABLEYE, SPECIES_MAKUHITA, SPECIES_SNORUNT, SPECIES_LUNATONE, SPECIES_SOLROCK, } },
    ...
    { SAFARI, { SPECIES_MANKEY, SPECIES_ABRA, SPECIES_DODUO, SPECIES_CUBONE, SPECIES_RHYHORN, SPECIES_CHANSEY, SPECIES_KANGASKHAN, SPECIES_TAUROS, SPECIES_AIPOM, SPECIES_GIRAFARIG, SPECIES_GLIGAR, SPECIES_SMEARGLE, SPECIES_SPINDA, SPECIES_KECLEON, SPECIES_TRAPINCH, SPECIES_CACNEA, } },
    { GHOST, { SPECIES_GASTLY, SPECIES_MISDREAVUS, SPECIES_DUSKULL, SPECIES_SHUPPET, } },
    { SHORE, { SPECIES_PSYDUCK, SPECIES_ABRA, SPECIES_SLOWPOKE, SPECIES_FARFETCHD, SPECIES_DITTO, SPECIES_YANMA, SPECIES_WOOPER, SPECIES_PHANPY, SPECIES_ZIGZAGOON, SPECIES_LOTAD, SPECIES_AZURILL, } },
    { ROCKS, { SPECIES_GEODUDE, SPECIES_SHUCKLE, SPECIES_LARVITAR, SPECIES_NINCADA, SPECIES_NOSEPASS, } },
    { SEA, { SPECIES_TENTACOOL, SPECIES_SEEL, SPECIES_SHELLDER, SPECIES_KRABBY, SPECIES_HORSEA, SPECIES_STARYU, SPECIES_MAGIKARP, SPECIES_OMANYTE, SPECIES_KABUTO, SPECIES_DRATINI, SPECIES_CHINCHOU, SPECIES_QWILFISH, SPECIES_CORSOLA, SPECIES_REMORAID, SPECIES_MANTINE, SPECIES_WINGULL, SPECIES_WAILMER, SPECIES_LUVDISC, SPECIES_CORPHISH, SPECIES_FEEBAS, SPECIES_CARVANHA, SPECIES_SPHEAL, } },
