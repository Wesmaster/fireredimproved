...
{
    // Rocks
    { ROCK_TUNNEL_B1F, ROCKS },
    { CERULEAN_CAVE_1F, ROCKS },
    { CERULEAN_CAVE_2F, ROCKS },
    { CERULEAN_CAVE_B1F, ROCKS },
};
...
const struct BasePokemonRandomizer sWaterMonsTable[] =
{
    // Lake
    { SSANNE_EXTERIOR, SEA },
    { SAFARI_ZONE_CENTER, SAFARI_LAKE },
    { SAFARI_ZONE_EAST, SAFARI_LAKE },
    { SAFARI_ZONE_NORTH, SAFARI_LAKE },
    { SAFARI_ZONE_WEST, SAFARI_LAKE },
    { CERULEAN_CAVE_1F, LAKE },
    { CERULEAN_CAVE_B1F, LAKE },
    { SEAFOAM_ISLANDS_B3F, LAKE },
    { SEAFOAM_ISLANDS_B4F, LAKE },
    { ROUTE4, LAKE },
    { ROUTE6, LAKE },
    { ROUTE10, LAKE },
    { ROUTE11, SEA },
...
{
    // Fishing
    { SSANNE_EXTERIOR, FISHING },
    { SAFARI_ZONE_CENTER, FISHING },
    { SAFARI_ZONE_EAST, FISHING },
    { SAFARI_ZONE_NORTH, FISHING },
    { SAFARI_ZONE_WEST, FISHING },
    { CERULEAN_CAVE_1F, FISHING },
    { CERULEAN_CAVE_B1F, FISHING },
    { SEAFOAM_ISLANDS_B3F, FISHING },
    { SEAFOAM_ISLANDS_B4F, FISHING },
    { ROUTE4, FISHING },
    { ROUTE6, FISHING },
    { ROUTE10, FISHING },
    { ROUTE11, FISHING },
    ...
    { ROUTE19, FISHING },
    { ROUTE20, FISHING },
    { ROUTE21_NORTH, FISHING },
    { ROUTE21_SOUTH, FISHING },
    { ROUTE22, FISHING },
    { ROUTE23, FISHING },
    { ROUTE24, FISHING },
    { ROUTE25, FISHING },
    { PALLET_TOWN, FISHING },
    { VIRIDIAN_CITY, FISHING },
    { CERULEAN_CITY, FISHING },
    { VERMILION_CITY, FISHING },
    { CELADON_CITY, FISHING },
    { FUCHSIA_CITY, FISHING },
    { CINNABAR_ISLAND, FISHING },
};
