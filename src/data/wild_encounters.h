...
const struct MapConfiguration sConfiguration[] = 
{
    ...
    { TUNNEL, { SPECIES_MACHOP, SPECIES_GEODUDE, SPECIES_GRAVELER, SPECIES_ONIX, SPECIES_RHYHORN, SPECIES_DITTO, } },
    { CAVE, { SPECIES_RATTATA, SPECIES_ZUBAT, SPECIES_PARAS, SPECIES_PARASECT, SPECIES_VENOMOTH, SPECIES_DIGLETT, SPECIES_ABRA, SPECIES_DITTO, } },
    { BUILDING, { SPECIES_RATTATA, SPECIES_EKANS, SPECIES_PIKACHU, SPECIES_ZUBAT, SPECIES_PARAS, SPECIES_ABRA, SPECIES_MAGNEMITE, SPECIES_GRIMER, SPECIES_GASTLY, SPECIES_VOLTORB, SPECIES_KOFFING, SPECIES_DITTO, } },
    { SAFARI { SPECIES_ARBOK, SPECIES_SANDSLASH, SPECIES_NIDORINA, SPECIES_NIDORINO, SPECIES_MANKEY, SPECIES_ABRA, SPECIES_DODUO, SPECIES_CUBONE, SPECIES_RHYHORN, SPECIES_CHANSEY, SPECIES_KANGASKHAN, SPECIES_TAUROS, SPECIES_LAPRAS, } },
