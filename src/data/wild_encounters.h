...
const struct MapConfiguration sConfiguration[] = 
{
    ...
    { CAVE, { SPECIES_RATTATA, SPECIES_ZUBAT, SPECIES_PARAS, SPECIES_VENOMOTH, SPECIES_DIGLETT, SPECIES_ABRA, SPECIES_DITTO, SPECIES_SPINARAK, SPECIES_DUNSPARCE, SPECIES_DELIBIRD, SPECIES_SABLEYE, SPECIES_MAKUHITA, SPECIES_SNORUNT, SPECIES_LUNATONE, SPECIES_SOLROCK, SPECIES_MEDITITE, SPECIES_WYNAUT, SPECIES_ABSOL, SPECIES_ARON, } },
    ...
    { SAFARI, { SPECIES_MANKEY, SPECIES_ABRA, SPECIES_DODUO, SPECIES_CUBONE, SPECIES_RHYHORN, SPECIES_CHANSEY, SPECIES_KANGASKHAN, SPECIES_TAUROS, SPECIES_AIPOM, SPECIES_GIRAFARIG, SPECIES_GLIGAR, SPECIES_SMEARGLE, SPECIES_SPINDA, SPECIES_KECLEON, SPECIES_TRAPINCH, SPECIES_CACNEA, SPECIES_SLAKOTH, SPECIES_TROPIUS, } },
