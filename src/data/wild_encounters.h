...
{
    { FOREST, { SPECIES_CATERPIE, SPECIES_WEEDLE, SPECIES_PIDGEY, SPECIES_RATTATA, SPECIES_SPEAROW, SPECIES_PICHU, SPECIES_NIDORAN_F, SPECIES_NIDORAN_M, SPECIES_VULPIX, SPECIES_PARAS, SPECIES_VENONAT, SPECIES_ABRA, SPECIES_BELLSPROUT, SPECIES_FARFETCHD, SPECIES_LICKITUNG, SPECIES_SCYTHER, SPECIES_PINSIR, SPECIES_DITTO, SPECIES_EEVEE, SPECIES_SENTRET, SPECIES_HOOTHOOT, SPECIES_SPINARAK, SPECIES_NATU, SPECIES_SUDOWOODO, SPECIES_MURKROW, SPECIES_PINECO, SPECIES_HERACROSS, SPECIES_TEDDIURSA, SPECIES_STANTLER, } },
    { FIELDS, { SPECIES_BUTTERFREE, SPECIES_BEEDRILL, SPECIES_PIDGEY, SPECIES_RATTATA, SPECIES_SPEAROW, SPECIES_EKANS, SPECIES_PICHU, SPECIES_SANDSHREW, SPECIES_VULPIX, SPECIES_ODDISH, SPECIES_ABRA, SPECIES_PONYTA, SPECIES_EXEGGCUTE, SPECIES_TANGELA, SPECIES_TAUROS, SPECIES_DITTO, SPECIES_EEVEE, SPECIES_SENTRET, SPECIES_HOOTHOOT, SPECIES_LEDYBA, SPECIES_SPINARAK, SPECIES_TOGEPI, SPECIES_NATU, SPECIES_MAREEP, SPECIES_HOPPIP, SPECIES_SUNKERN, SPECIES_YANMA, SPECIES_MURKROW, SPECIES_WYNAUT, SPECIES_SNEASEL, SPECIES_SWINUB, SPECIES_SKARMORY, SPECIES_STANTLER, SPECIES_MILTANK, } },
    { GARDEN, { SPECIES_BUTTERFREE, SPECIES_BEEDRILL, SPECIES_MEOWTH, SPECIES_GROWLITHE, SPECIES_ABRA, SPECIES_DITTO, SPECIES_LEDYBA, SPECIES_SPINARAK, SPECIES_HOPPIP, SPECIES_SUNKERN, SPECIES_SNUBBULL, SPECIES_HOUNDOUR, } },
    { TUNNEL, { SPECIES_MACHOP, SPECIES_GEODUDE, SPECIES_ONIX, SPECIES_RHYHORN, SPECIES_DITTO, SPECIES_SPINARAK, } },
    { CAVE, { SPECIES_RATTATA, SPECIES_ZUBAT, SPECIES_PARAS, SPECIES_VENOMOTH, SPECIES_DIGLETT, SPECIES_ABRA, SPECIES_DITTO, SPECIES_SPINARAK, SPECIES_DUNSPARCE, SPECIES_DELIBIRD, } },
    { BUILDING, { SPECIES_RATTATA, SPECIES_EKANS, SPECIES_PICHU, SPECIES_ZUBAT, SPECIES_PARAS, SPECIES_ABRA, SPECIES_MAGNEMITE, SPECIES_GRIMER, SPECIES_GASTLY, SPECIES_VOLTORB, SPECIES_KOFFING, SPECIES_DITTO, SPECIES_MISDREAVUS, SPECIES_UNOWN, SPECIES_ELEKID, } },
    { SAFARI, { SPECIES_MANKEY, SPECIES_ABRA, SPECIES_DODUO, SPECIES_CUBONE, SPECIES_RHYHORN, SPECIES_CHANSEY, SPECIES_KANGASKHAN, SPECIES_TAUROS, SPECIES_AIPOM, SPECIES_GIRAFARIG, SPECIES_GLIGAR, SPECIES_SMEARGLE, } },
    { GHOST, { SPECIES_GASTLY, SPECIES_MISDREAVUS, } },
    { SHORE, { SPECIES_PSYDUCK, SPECIES_ABRA, SPECIES_SLOWPOKE, SPECIES_FARFETCHD, SPECIES_DITTO, SPECIES_YANMA, SPECIES_WOOPER, SPECIES_PHANPY, } },
    { ROCKS, { SPECIES_GEODUDE, SPECIES_SHUCKLE, SPECIES_LARVITAR, } },
    { SEA, { SPECIES_TENTACOOL, SPECIES_SEEL, SPECIES_SHELLDER, SPECIES_HORSEA, SPECIES_STARYU, SPECIES_MAGIKARP, SPECIES_OMANYTE, SPECIES_KABUTO, SPECIES_DRATINI, SPECIES_CHINCHOU, SPECIES_QWILFISH, SPECIES_CORSOLA, SPECIES_REMORAID, SPECIES_MANTINE, } },
    { LAKE, { SPECIES_POLIWAG, SPECIES_GOLDEEN, SPECIES_MAGIKARP, SPECIES_WOOPER, } },
    { BEACH, { SPECIES_TENTACOOL, SPECIES_SLOWPOKE, SPECIES_SLOWBRO, SPECIES_SHELLDER, SPECIES_KRABBY, SPECIES_STARYU, SPECIES_DITTO, } },
    { VOLCANO, { SPECIES_MAGBY, SPECIES_SLUGMA, } },
    { CITY, { SPECIES_RATTATA, SPECIES_PICHU, SPECIES_MEOWTH, SPECIES_GROWLITHE, SPECIES_GRIMER, SPECIES_DROWZEE, SPECIES_KOFFING, SPECIES_MR_MIME, SPECIES_DITTO, SPECIES_PORYGON, SPECIES_LEDYBA, SPECIES_SPINARAK, SPECIES_IGGLYBUFF, SPECIES_SNUBBULL, SPECIES_DELIBIRD, SPECIES_HOUNDOUR, } },
    { TOWN, { SPECIES_PIDGEY, SPECIES_SPEAROW, SPECIES_PICHU, SPECIES_MEOWTH, SPECIES_GROWLITHE, SPECIES_PONYTA, SPECIES_DROWZEE, SPECIES_TAUROS, SPECIES_DITTO, SPECIES_LEDYBA, SPECIES_SPINARAK, SPECIES_NATU, SPECIES_MAREEP, SPECIES_MURKROW, SPECIES_SNUBBULL, SPECIES_HOUNDOUR, SPECIES_MILTANK, } },
    { FISHING, { SPECIES_TENTACOOL, SPECIES_GOLDEEN, SPECIES_MAGIKARP, SPECIES_DRATINI, SPECIES_QWILFISH, SPECIES_REMORAID, SPECIES_MANTINE, } },
