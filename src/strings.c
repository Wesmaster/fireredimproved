...
const u8 gText_PokeSum_PageName_PokemonSkillsIv[] = _("Pokémon IV's");
const u8 gText_PokeSum_PageName_PokemonSkillsEv[] = _("Pokémon EV's");
...
const u8 gText_PokeSum_Controls_Page[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}DETAIL");
